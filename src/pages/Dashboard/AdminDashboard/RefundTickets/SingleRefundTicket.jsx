...
const SingleRefundTicket = () => {
  ...
  const getTicket = () => {
    fetchData(`/api/course/orders/refunds/${ticketId}`, undefined, (res) => {
  ...
  const handleStatus = (refundTicket, status) => {
    ...
    putData(
      `/api/admin/course/orders/refunds/${refundTicket?.refundId}`,
      {
        status: status,
        orderId: refundTicket?.order?.orderId,
      },
      undefined,
      (res) => {
  ...
  const handleReject = (values) => {
    ...
    putData(
      `/api/admin/course/orders/refunds/${ticket.refundId}`,
      payload,
      undefined,
  ...
  useEffect(() => {
    ...
    if (
      user.role === "admin" ||
      ticket?.course?.user?.email === user?.email ||
...
export default SingleRefundTicket;
