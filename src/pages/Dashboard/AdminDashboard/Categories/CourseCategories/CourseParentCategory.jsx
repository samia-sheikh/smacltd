...
import { setSingleParentCategoryCourse } from "../../../../../features/slice/categoriesSlice";
...
const CourseParentCategory = ({ setCourseCategory }) => {
  ...
  useEffect(() => {
    fetchData("/api/course/parent", undefined, (res) => {
  ...
  const handleGlobalSearch = (event) => {
    ...
    try {
      fetchData(
        `/api/admin/course/parent/search?searchQuery=${event.target.value}`,
        undefined,
        (res) => {
          if (res) {
            setCourseCategories(res.data);
    ...
    <>
      ...
      {categoryToEdit && (
        <EditParentCategory
          ...
          url={`/api/admin/course/parent/${categoryToEdit?.courseParentCategoryId}`}
          anyChanges={setAnyCategoryChanges}
        />
      )}
      {/* {deleteCategory ? (
                ...
                <TableCell width={230}>
                  ...
                  <Box sx={{ display: "flex", gap: "10px" }}>
                    <ButtonComp
                      ...
                      click={() => {
                        dispatch(
                          setSingleParentCategoryCourse({ data: category })
                        );
...
export default CourseParentCategory;
